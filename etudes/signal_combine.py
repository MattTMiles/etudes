...
@register_pytree_node_class
class Etudes1PsrSignal_MM_edit(object):
    """
    The point of this class is to change the original class in such a way that
    it can return everything it needs to by just reading in a noise file. There 
    is likely a better way to do this, but for this test I think it'll work.
    """
    def __init__(self, T=None, TNT=None, psr=None, backend_select=False,
                 has_wn=True, has_basis_ecorr=True,
                 has_rn=True, has_tm=True, has_gwb=True, has_cw=True,
